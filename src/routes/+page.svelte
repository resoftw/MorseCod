<script lang="ts">
	...
	const edges: { code: string; d: string }[] = [
		...
		{ code: '--', d: 'M 138 60 H 112.5' },
		{ code: '---', d: 'M 95.5 60 H 70' },
		{ code: '.', d: 'M 188 60 H 203.5' },
		{ code: '..', d: 'M 220.5 60 H 236.5' },
		{ code: '...', d: 'M 253.5 60 H 269.5' },
		{ code: '....', d: 'M 286.5 60 H 308' },
		// left letters
		{ code: '--.', d: 'M 104 68.5 V 103.5' },
		{ code: '--.-', d: 'M 95.5 112 H 70' },
		{ code: '--..', d: 'M 104 120.5 V 141.5' },
		{ code: '-.', d: 'M 150 66 V 196.5' },
		{ code: '-.-', d: 'M 141.5 205 H 112.5' },
		{ code: '-.--', d: 'M 95.5 205 H 70' },
		{ code: '-.-.', d: 'M 104 213.5 V 238.5' },
